...
const instanceResult = async function(req, res, category) {
    ...
    return res.send({code : 404, msg : `${category} 기록이 없습니다!`})
}

// return record by category
...
// inner function
// get record category by recordInstance
...
// classify category and find related record
